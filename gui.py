...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        CurrentWL = QLabel('Current Word:')
        CurrentWord = QLineEdit()
        ...
        webcam_layout.addWidget(primary_container, 1, 0)
        primary_layout.addWidget(self.current_letter, 1, 0)
        primary_layout.addWidget(self.unc_letter, 1, 2)
        primary_layout.addWidget(self.confidence, 2, 0)
        primary_layout.addWidget(self.unc_confidence, 2, 2)
        primary_layout.addWidget(CurrentWL, 3, 0)
        primary_layout.addWidget(CurrentWord, 4, 0)
        primary_layout.addWidget(confirm_btn, 5, 1)
